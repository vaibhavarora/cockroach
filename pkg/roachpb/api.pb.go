...
/*
	...
	It has these top-level messages:
		...
		ReverseScanRequest
		ReverseScanResponse
		GetTransactionRecordRequest
		GetTransactionRecordResponse
...
// A GetTransactionRecordRequest request to get the Transaction record taged to the key specified in span
type GetTransactionRecordRequest struct {
	Span `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *GetTransactionRecordRequest) Reset()                    { *m = GetTransactionRecordRequest{} }
func (m *GetTransactionRecordRequest) String() string            { return proto.CompactTextString(m) }
func (*GetTransactionRecordRequest) ProtoMessage()               {}
func (*GetTransactionRecordRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{20} }

// A GetTransactionRecordResponse is a response that has Transaction record
type GetTransactionRecordResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	TxnRecord      Transaction `protobuf:"bytes,2,opt,name=txn_record,json=txnRecord" json:"txn_record"`
}

func (m *GetTransactionRecordResponse) Reset()                    { *m = GetTransactionRecordResponse{} }
func (m *GetTransactionRecordResponse) String() string            { return proto.CompactTextString(m) }
func (*GetTransactionRecordResponse) ProtoMessage()               {}
func (*GetTransactionRecordResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{21} }
...
func (*UpdateTransactionRecordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{22}
}
...
func (*ChangeFrozenRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{26} }
...
func (*ChangeFrozenResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{27} }
...
func (*RangeLookupRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{38} }
...
func (*RangeLookupResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{39} }
...
type RequestUnion struct {
	...
	GetTxnRecord             *GetTransactionRecordRequest     `protobuf:"bytes,31,opt,name=get_txn_record,json=getTxnRecord" json:"get_txn_record,omitempty"`
	UpdateTxnRecord          *UpdateTransactionRecordRequest  `protobuf:"bytes,32,opt,name=update_txn_record,json=updateTxnRecord" json:"update_txn_record,omitempty"`
}
...
type ResponseUnion struct {
	...
	GetTxnRecord             *GetTransactionRecordResponse     `protobuf:"bytes,31,opt,name=get_txn_record,json=getTxnRecord" json:"get_txn_record,omitempty"`
	UpdateTxnRecord          *UpdateTransactionRecordResponse  `protobuf:"bytes,32,opt,name=update_txn_record,json=updateTxnRecord" json:"update_txn_record,omitempty"`
}
...
func (*ReadSoftLock) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{69} }
...
func (*WriteSoftLock) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{70} }
...
func init() {
	...
	proto.RegisterType((*GetTransactionRecordRequest)(nil), "cockroach.roachpb.GetTransactionRecordRequest")
	proto.RegisterType((*GetTransactionRecordResponse)(nil), "cockroach.roachpb.GetTransactionRecordResponse")
...
func (m *GetTransactionRecordRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetTransactionRecordRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetTransactionRecordResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetTransactionRecordResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	n30, err := m.TxnRecord.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
...
func (m *UpdateTransactionRecordRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.TxnRecord.Size()))
	n32, err := m.TxnRecord.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n32
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		n93, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n93
	...
	if m.Put != nil {
		...
		n94, err := m.Put.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n94
	...
	if m.ConditionalPut != nil {
		...
		n95, err := m.ConditionalPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n95
	...
	if m.Increment != nil {
		...
		n96, err := m.Increment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n96
	...
	if m.Delete != nil {
		...
		n97, err := m.Delete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n97
	...
	if m.DeleteRange != nil {
		...
		n98, err := m.DeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n98
	...
	if m.Scan != nil {
		...
		n99, err := m.Scan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n99
	...
	if m.BeginTransaction != nil {
		...
		n100, err := m.BeginTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n100
	...
	if m.EndTransaction != nil {
		...
		n101, err := m.EndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n101
	...
	if m.AdminSplit != nil {
		...
		n102, err := m.AdminSplit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n102
	...
	if m.AdminMerge != nil {
		...
		n103, err := m.AdminMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n103
	...
	if m.HeartbeatTxn != nil {
		...
		n104, err := m.HeartbeatTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n104
	...
	if m.Gc != nil {
		...
		n105, err := m.Gc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n105
	...
	if m.PushTxn != nil {
		...
		n106, err := m.PushTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n106
	...
	if m.RangeLookup != nil {
		...
		n107, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n107
	...
	if m.ResolveIntent != nil {
		...
		n108, err := m.ResolveIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n108
	...
	if m.ResolveIntentRange != nil {
		...
		n109, err := m.ResolveIntentRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n109
	...
	if m.Merge != nil {
		...
		n110, err := m.Merge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n110
	...
	if m.TruncateLog != nil {
		...
		n111, err := m.TruncateLog.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n111
	...
	if m.RequestLease != nil {
		...
		n112, err := m.RequestLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.ReverseScan != nil {
		...
		n113, err := m.ReverseScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n113
	...
	if m.ComputeChecksum != nil {
		...
		n114, err := m.ComputeChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n114
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		n115, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n115
	...
	if m.CheckConsistency != nil {
		...
		n116, err := m.CheckConsistency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n116
	...
	if m.Noop != nil {
		...
		n117, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n117
	...
	if m.InitPut != nil {
		...
		n118, err := m.InitPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n118
	...
	if m.ChangeFrozen != nil {
		...
		n119, err := m.ChangeFrozen.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n119
	...
	if m.TransferLease != nil {
		...
		n120, err := m.TransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n120
	...
	if m.AdminTransferLease != nil {
		...
		n121, err := m.AdminTransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n121
	...
	if m.LeaseInfo != nil {
		...
		n122, err := m.LeaseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n122
	}
	if m.GetTxnRecord != nil {
		dAtA[i] = 0xfa
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GetTxnRecord.Size()))
		n123, err := m.GetTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n123
	...
	if m.UpdateTxnRecord != nil {
		...
		n124, err := m.UpdateTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n124
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GetTxnRecord != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GetTxnRecord.Size()))
		n154, err := m.GetTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n154
	...
	if m.UpdateTxnRecord != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpdateTxnRecord.Size()))
		n155, err := m.UpdateTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n155
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	n157, err := m.Replica.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n157
	...
	if m.TraceContext != nil {
		...
		n159, err := m.TraceContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n159
...
func (m *ReadSoftLock) MarshalTo(dAtA []byte) (int, error) {
	...
	n161, err := m.TransactionMeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n161
...
func (m *WriteSoftLock) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.TransactionMeta.Size()))
	n162, err := m.TransactionMeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n162
	...
	n163, err := m.Request.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n163
...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n164, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n164
...
func (m *BatchResponse_Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		...
		n165, err := m.Error.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n165
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Timestamp.Size()))
	n166, err := m.Timestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n166
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n167, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n167
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n168, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n168
...
func (m *GetTransactionRecordRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *GetTransactionRecordResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (this *RequestUnion) GetValue() interface{} {
	...
	if this.GetTxnRecord != nil {
		return this.GetTxnRecord
	}
...
func (this *RequestUnion) SetValue(value interface{}) bool {
	...
	case *LeaseInfoRequest:
		this.LeaseInfo = vt
	case *GetTransactionRecordRequest:
		this.GetTxnRecord = vt
...
func (this *ResponseUnion) SetValue(value interface{}) bool {
	...
	case *LeaseInfoResponse:
		this.LeaseInfo = vt
	case *GetTransactionRecordResponse:
		this.GetTxnRecord = vt
...
func (m *GetTransactionRecordRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetTransactionRecordRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetTransactionRecordRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetTransactionRecordResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetTransactionRecordResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetTransactionRecordResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GetTxnRecord", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GetTxnRecord == nil {
				m.GetTxnRecord = &GetTransactionRecordRequest{}
			}
			if err := m.GetTxnRecord.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 32:
...
func (m *ResponseUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			...
			if m.GetTxnRecord == nil {
				m.GetTxnRecord = &GetTransactionRecordResponse{}
			}
			if err := m.GetTxnRecord.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
