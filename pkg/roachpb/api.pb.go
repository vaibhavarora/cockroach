...
/*
	...
	It has these top-level messages:
		...
		UpdateTransactionRecordResponse
		ResolveWriteSoftLocksRequest
		ResolveWriteSoftLocksResponse
		GCWriteSoftockRequest
		GCWriteSoftockResponse
		GCReadSoftockRequest
		GCReadSoftockResponse
		DyTSEndTransactionRequest
		DyTSEndTransactionResponse
		ValidateCommitAfterRequest
		ValidateCommitAfterResponse
		ValidateCommitBeforeRequest
		ValidateCommitBeforeResponse
...
// A UpdateTranasactionRequest updates the Transaction record
type UpdateTransactionRecordRequest struct {
	Span             `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Tmeta            cockroach_storage_engine_enginepb.TxnMeta   `protobuf:"bytes,2,opt,name=tmeta" json:"tmeta"`
	LowerBound       cockroach_util_hlc.Timestamp                `protobuf:"bytes,3,opt,name=LowerBound" json:"LowerBound"`
	UpperBound       cockroach_util_hlc.Timestamp                `protobuf:"bytes,4,opt,name=UpperBound" json:"UpperBound"`
	CommitAfterThem  []cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,5,rep,name=commitAfterThem" json:"commitAfterThem"`
	CommitBeforeThem []cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,6,rep,name=commitBeforeThem" json:"commitBeforeThem"`
}

func (m *UpdateTransactionRecordRequest) Reset()         { *m = UpdateTransactionRecordRequest{} }
func (m *UpdateTransactionRecordRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateTransactionRecordRequest) ProtoMessage()    {}
func (*UpdateTransactionRecordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{20}
}

// Response for UpdateTranasactionRequest
type UpdateTransactionRecordResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *UpdateTransactionRecordResponse) Reset()         { *m = UpdateTransactionRecordResponse{} }
func (m *UpdateTransactionRecordResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateTransactionRecordResponse) ProtoMessage()    {}
func (*UpdateTransactionRecordResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{21}
}

// Resolve write soft lock request
type ResolveWriteSoftLocksRequest struct {
	Span      `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Txnrecord Transaction `protobuf:"bytes,2,opt,name=txnrecord" json:"txnrecord"`
}

func (m *ResolveWriteSoftLocksRequest) Reset()                    { *m = ResolveWriteSoftLocksRequest{} }
func (m *ResolveWriteSoftLocksRequest) String() string            { return proto.CompactTextString(m) }
func (*ResolveWriteSoftLocksRequest) ProtoMessage()               {}
func (*ResolveWriteSoftLocksRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{22} }

// Response for ResolveWriteSoftLocksRequest
type ResolveWriteSoftLocksResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *ResolveWriteSoftLocksResponse) Reset()         { *m = ResolveWriteSoftLocksResponse{} }
func (m *ResolveWriteSoftLocksResponse) String() string { return proto.CompactTextString(m) }
func (*ResolveWriteSoftLocksResponse) ProtoMessage()    {}
func (*ResolveWriteSoftLocksResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{23}
}

// Grabage collect write soft locks
type GCWriteSoftockRequest struct {
	Span      `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Txnrecord Transaction `protobuf:"bytes,2,opt,name=txnrecord" json:"txnrecord"`
}

func (m *GCWriteSoftockRequest) Reset()                    { *m = GCWriteSoftockRequest{} }
func (m *GCWriteSoftockRequest) String() string            { return proto.CompactTextString(m) }
func (*GCWriteSoftockRequest) ProtoMessage()               {}
func (*GCWriteSoftockRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{24} }

type GCWriteSoftockResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *GCWriteSoftockResponse) Reset()                    { *m = GCWriteSoftockResponse{} }
func (m *GCWriteSoftockResponse) String() string            { return proto.CompactTextString(m) }
func (*GCWriteSoftockResponse) ProtoMessage()               {}
func (*GCWriteSoftockResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{25} }

// Grabage collect read soft locks
type GCReadSoftockRequest struct {
	Span      `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Reverse   bool        `protobuf:"varint,2,opt,name=reverse" json:"reverse"`
	Txnrecord Transaction `protobuf:"bytes,3,opt,name=txnrecord" json:"txnrecord"`
}

func (m *GCReadSoftockRequest) Reset()                    { *m = GCReadSoftockRequest{} }
func (m *GCReadSoftockRequest) String() string            { return proto.CompactTextString(m) }
func (*GCReadSoftockRequest) ProtoMessage()               {}
func (*GCReadSoftockRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{26} }

type GCReadSoftockResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *GCReadSoftockResponse) Reset()                    { *m = GCReadSoftockResponse{} }
func (m *GCReadSoftockResponse) String() string            { return proto.CompactTextString(m) }
func (*GCReadSoftockResponse) ProtoMessage()               {}
func (*GCReadSoftockResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{27} }

// Request to EndTransaction from dynamic timestamp validator
type DyTSEndTransactionRequest struct {
	Span   `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	...
	// List of keys writen by transaction
	WriteSpans []Span `protobuf:"bytes,5,rep,name=write_spans,json=writeSpans" json:"write_spans"`
	// List of keys read by the transaction.
	ReadSpans []Span `protobuf:"bytes,6,rep,name=read_spans,json=readSpans" json:"read_spans"`
	// List of keys read by the transaction in reverse.
	ReverseReadSpans []Span                                    `protobuf:"bytes,7,rep,name=reverse_read_spans,json=reverseReadSpans" json:"reverse_read_spans"`
	Tmeta            cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,8,opt,name=tmeta" json:"tmeta"`
}

func (m *DyTSEndTransactionRequest) Reset()                    { *m = DyTSEndTransactionRequest{} }
func (m *DyTSEndTransactionRequest) String() string            { return proto.CompactTextString(m) }
func (*DyTSEndTransactionRequest) ProtoMessage()               {}
func (*DyTSEndTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{28} }

type DyTSEndTransactionResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *DyTSEndTransactionResponse) Reset()                    { *m = DyTSEndTransactionResponse{} }
func (m *DyTSEndTransactionResponse) String() string            { return proto.CompactTextString(m) }
func (*DyTSEndTransactionResponse) ProtoMessage()               {}
func (*DyTSEndTransactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{29} }

type ValidateCommitAfterRequest struct {
	Span       `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Tmeta      cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,2,opt,name=tmeta" json:"tmeta"`
	LowerBound *cockroach_util_hlc.Timestamp             `protobuf:"bytes,3,opt,name=lowerBound" json:"lowerBound,omitempty"`
}

func (m *ValidateCommitAfterRequest) Reset()                    { *m = ValidateCommitAfterRequest{} }
func (m *ValidateCommitAfterRequest) String() string            { return proto.CompactTextString(m) }
func (*ValidateCommitAfterRequest) ProtoMessage()               {}
func (*ValidateCommitAfterRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{30} }

type ValidateCommitAfterResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	LowerBound     *cockroach_util_hlc.Timestamp `protobuf:"bytes,3,opt,name=lowerBound" json:"lowerBound,omitempty"`
}

func (m *ValidateCommitAfterResponse) Reset()                    { *m = ValidateCommitAfterResponse{} }
func (m *ValidateCommitAfterResponse) String() string            { return proto.CompactTextString(m) }
func (*ValidateCommitAfterResponse) ProtoMessage()               {}
func (*ValidateCommitAfterResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{31} }

type ValidateCommitBeforeRequest struct {
	Span       `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Tmeta      cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,2,opt,name=tmeta" json:"tmeta"`
	UpperBound *cockroach_util_hlc.Timestamp             `protobuf:"bytes,3,opt,name=upperBound" json:"upperBound,omitempty"`
}

func (m *ValidateCommitBeforeRequest) Reset()                    { *m = ValidateCommitBeforeRequest{} }
func (m *ValidateCommitBeforeRequest) String() string            { return proto.CompactTextString(m) }
func (*ValidateCommitBeforeRequest) ProtoMessage()               {}
func (*ValidateCommitBeforeRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{32} }

type ValidateCommitBeforeResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	UpperBound     *cockroach_util_hlc.Timestamp `protobuf:"bytes,3,opt,name=upperBound" json:"upperBound,omitempty"`
}

func (m *ValidateCommitBeforeResponse) Reset()                    { *m = ValidateCommitBeforeResponse{} }
func (m *ValidateCommitBeforeResponse) String() string            { return proto.CompactTextString(m) }
func (*ValidateCommitBeforeResponse) ProtoMessage()               {}
func (*ValidateCommitBeforeResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{33} }
...
func (*CheckConsistencyRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{34} }
...
func (*CheckConsistencyResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{35} }
...
func (*ChangeFrozenRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{36} }
...
func (*ChangeFrozenResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{37} }
...
func (*BeginTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{38} }
...
func (*BeginTransactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{39} }
...
func (*EndTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{40} }
...
func (*EndTransactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{41} }
...
func (*AdminSplitRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{42} }
...
func (*AdminSplitResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{43} }
...
func (*AdminMergeRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{44} }
...
func (*AdminMergeResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{45} }
...
func (*AdminTransferLeaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{46} }
...
func (*AdminTransferLeaseResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{47} }
...
func (*RangeLookupRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{48} }
...
func (*RangeLookupResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{49} }
...
func (*HeartbeatTxnRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{50} }
...
func (*HeartbeatTxnResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{51} }
...
func (*GCRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{52} }
...
func (*GCRequest_GCKey) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{52, 0} }
...
func (*GCResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{53} }
...
func (*PushTxnRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{54} }
...
func (*PushTxnResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{55} }
...
func (*ResolveIntentRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{56} }
...
func (*ResolveIntentResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{57} }
...
func (*ResolveIntentRangeRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{58} }
...
func (*NoopResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{59} }
...
func (*NoopRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{60} }
...
func (*ResolveIntentRangeResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{61} }
...
func (*MergeRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{62} }
...
func (*MergeResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{63} }
...
func (*TruncateLogRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{64} }
...
func (*TruncateLogResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{65} }
...
func (*RequestLeaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{66} }
...
func (*TransferLeaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{67} }
...
func (*LeaseInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{68} }
...
func (*LeaseInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{69} }
...
func (*RequestLeaseResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{70} }
...
func (*ComputeChecksumRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{71} }
...
func (*ComputeChecksumResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{72} }
...
func (*DeprecatedVerifyChecksumRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{73}
}
...
func (*DeprecatedVerifyChecksumResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{74}
}
...
type RequestUnion struct {
	...
	UpdateTxnRecord          *UpdateTransactionRecordRequest  `protobuf:"bytes,31,opt,name=update_txn_record,json=updateTxnRecord" json:"update_txn_record,omitempty"`
	ResolveWriteSlock        *ResolveWriteSoftLocksRequest    `protobuf:"bytes,32,opt,name=resolve_write_slock,json=resolveWriteSlock" json:"resolve_write_slock,omitempty"`
	DyTsEndTransaction       *DyTSEndTransactionRequest       `protobuf:"bytes,33,opt,name=dy_ts_end_transaction,json=dyTsEndTransaction" json:"dy_ts_end_transaction,omitempty"`
	ValidateCommitAfter      *ValidateCommitAfterRequest      `protobuf:"bytes,34,opt,name=validate_commit_after,json=validateCommitAfter" json:"validate_commit_after,omitempty"`
	ValidateCommitBefore     *ValidateCommitBeforeRequest     `protobuf:"bytes,35,opt,name=validate_commit_before,json=validateCommitBefore" json:"validate_commit_before,omitempty"`
	GcWriteSoftLock          *GCWriteSoftockRequest           `protobuf:"bytes,36,opt,name=gc_write_soft_lock,json=gcWriteSoftLock" json:"gc_write_soft_lock,omitempty"`
	GcReadSoftLock           *GCReadSoftockRequest            `protobuf:"bytes,37,opt,name=gc_read_soft_lock,json=gcReadSoftLock" json:"gc_read_soft_lock,omitempty"`
}
...
type ResponseUnion struct {
	...
	UpdateTxnRecord          *UpdateTransactionRecordResponse  `protobuf:"bytes,31,opt,name=update_txn_record,json=updateTxnRecord" json:"update_txn_record,omitempty"`
	ResolveWriteSlock        *ResolveWriteSoftLocksResponse    `protobuf:"bytes,32,opt,name=resolve_write_slock,json=resolveWriteSlock" json:"resolve_write_slock,omitempty"`
	DyTsEndTransaction       *DyTSEndTransactionResponse       `protobuf:"bytes,33,opt,name=dy_ts_end_transaction,json=dyTsEndTransaction" json:"dy_ts_end_transaction,omitempty"`
	ValidateCommitAfter      *ValidateCommitAfterResponse      `protobuf:"bytes,34,opt,name=validate_commit_after,json=validateCommitAfter" json:"validate_commit_after,omitempty"`
	ValidateCommitBefore     *ValidateCommitBeforeResponse     `protobuf:"bytes,35,opt,name=validate_commit_before,json=validateCommitBefore" json:"validate_commit_before,omitempty"`
	GcWriteSoftLock          *GCWriteSoftockResponse           `protobuf:"bytes,36,opt,name=gc_write_soft_lock,json=gcWriteSoftLock" json:"gc_write_soft_lock,omitempty"`
	GcReadSoftLock           *GCReadSoftockResponse            `protobuf:"bytes,37,opt,name=gc_read_soft_lock,json=gcReadSoftLock" json:"gc_read_soft_lock,omitempty"`
}
...
// A Read Soft Lock placed on each read for Dynamic Time stamping
type ReadSoftLock struct {
	TransactionMeta cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,1,opt,name=TransactionMeta" json:"TransactionMeta"`
}

func (m *ReadSoftLock) Reset()                    { *m = ReadSoftLock{} }
func (m *ReadSoftLock) String() string            { return proto.CompactTextString(m) }
func (*ReadSoftLock) ProtoMessage()               {}
func (*ReadSoftLock) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{79} }

// A Write Lock placed on each write fir Dynamic Time stamping
type WriteSoftLock struct {
	TransactionMeta cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,1,opt,name=TransactionMeta" json:"TransactionMeta"`
	Request         RequestUnion                              `protobuf:"bytes,2,opt,name=Request" json:"Request"`
}

func (m *WriteSoftLock) Reset()                    { *m = WriteSoftLock{} }
func (m *WriteSoftLock) String() string            { return proto.CompactTextString(m) }
func (*WriteSoftLock) ProtoMessage()               {}
func (*WriteSoftLock) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{80} }
...
func init() {
	...
	proto.RegisterType((*UpdateTransactionRecordRequest)(nil), "cockroach.roachpb.UpdateTransactionRecordRequest")
	proto.RegisterType((*UpdateTransactionRecordResponse)(nil), "cockroach.roachpb.UpdateTransactionRecordResponse")
	proto.RegisterType((*ResolveWriteSoftLocksRequest)(nil), "cockroach.roachpb.ResolveWriteSoftLocksRequest")
	proto.RegisterType((*ResolveWriteSoftLocksResponse)(nil), "cockroach.roachpb.ResolveWriteSoftLocksResponse")
	proto.RegisterType((*GCWriteSoftockRequest)(nil), "cockroach.roachpb.GCWriteSoftockRequest")
	proto.RegisterType((*GCWriteSoftockResponse)(nil), "cockroach.roachpb.GCWriteSoftockResponse")
	proto.RegisterType((*GCReadSoftockRequest)(nil), "cockroach.roachpb.GCReadSoftockRequest")
	proto.RegisterType((*GCReadSoftockResponse)(nil), "cockroach.roachpb.GCReadSoftockResponse")
	proto.RegisterType((*DyTSEndTransactionRequest)(nil), "cockroach.roachpb.DyTSEndTransactionRequest")
	proto.RegisterType((*DyTSEndTransactionResponse)(nil), "cockroach.roachpb.DyTSEndTransactionResponse")
	proto.RegisterType((*ValidateCommitAfterRequest)(nil), "cockroach.roachpb.ValidateCommitAfterRequest")
	proto.RegisterType((*ValidateCommitAfterResponse)(nil), "cockroach.roachpb.ValidateCommitAfterResponse")
	proto.RegisterType((*ValidateCommitBeforeRequest)(nil), "cockroach.roachpb.ValidateCommitBeforeRequest")
	proto.RegisterType((*ValidateCommitBeforeResponse)(nil), "cockroach.roachpb.ValidateCommitBeforeResponse")
	...
	proto.RegisterType((*ReadSoftLock)(nil), "cockroach.roachpb.ReadSoftLock")
	proto.RegisterType((*WriteSoftLock)(nil), "cockroach.roachpb.WriteSoftLock")
...
func (m *UpdateTransactionRecordRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateTransactionRecordRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Tmeta.Size()))
	n29, err := m.Tmeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n29
	dAtA[i] = 0x1a
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.LowerBound.Size()))
	n30, err := m.LowerBound.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
	dAtA[i] = 0x22
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.UpperBound.Size()))
	n31, err := m.UpperBound.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n31
	if len(m.CommitAfterThem) > 0 {
		for _, msg := range m.CommitAfterThem {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintApi(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.CommitBeforeThem) > 0 {
		for _, msg := range m.CommitBeforeThem {
			dAtA[i] = 0x32
			i++
			i = encodeVarintApi(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *UpdateTransactionRecordResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateTransactionRecordResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResolveWriteSoftLocksRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResolveWriteSoftLocksRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Txnrecord.Size()))
	n34, err := m.Txnrecord.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *ResolveWriteSoftLocksResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResolveWriteSoftLocksResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GCWriteSoftockRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GCWriteSoftockRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Txnrecord.Size()))
	n37, err := m.Txnrecord.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
...
func (m *GCWriteSoftockResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GCWriteSoftockResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GCReadSoftockRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GCReadSoftockRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Txnrecord.Size()))
	n40, err := m.Txnrecord.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
...
func (m *GCReadSoftockResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GCReadSoftockResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DyTSEndTransactionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DyTSEndTransactionRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.ReverseReadSpans) > 0 {
		for _, msg := range m.ReverseReadSpans {
			dAtA[i] = 0x3a
			i++
			i = encodeVarintApi(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Tmeta.Size()))
	n45, err := m.Tmeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n45
...
func (m *DyTSEndTransactionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DyTSEndTransactionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ValidateCommitAfterRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ValidateCommitAfterRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Tmeta.Size()))
	n48, err := m.Tmeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
	if m.LowerBound != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.LowerBound.Size()))
		n49, err := m.LowerBound.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *ValidateCommitAfterResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ValidateCommitAfterResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.LowerBound != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.LowerBound.Size()))
		n51, err := m.LowerBound.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *ValidateCommitBeforeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ValidateCommitBeforeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Tmeta.Size()))
	n53, err := m.Tmeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n53
	if m.UpperBound != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpperBound.Size()))
		n54, err := m.UpperBound.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *ValidateCommitBeforeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ValidateCommitBeforeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.UpperBound != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpperBound.Size()))
		n56, err := m.UpperBound.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *EndTransactionRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Deadline != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Deadline.Size()))
		n64, err := m.Deadline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
	...
	if m.InternalCommitTrigger != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.InternalCommitTrigger.Size()))
		n65, err := m.InternalCommitTrigger.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *HeartbeatTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n76, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n76
...
func (m *GCRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n79, err := m.Threshold.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n79
	...
	n80, err := m.TxnSpanGCThreshold.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n80
...
func (m *PushTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n84, err := m.PusherTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n84
	...
	n85, err := m.PusheeTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n85
	...
	n86, err := m.PushTo.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n86
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n87, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n87
...
func (m *PushTxnResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.PusheeTxn.Size()))
	n89, err := m.PusheeTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n89
...
func (m *ResolveIntentRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n91, err := m.IntentTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n91
...
func (m *ResolveIntentRangeRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.IntentTxn.Size()))
	n94, err := m.IntentTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n94
...
func (m *MergeRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Value.Size()))
	n97, err := m.Value.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n97
...
func (m *TransferLeaseRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrevLease != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.PrevLease.Size()))
		n106, err := m.PrevLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n106
...
func (m *LeaseInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Lease != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Lease.Size()))
		n109, err := m.Lease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n109
...
func (m *ComputeChecksumRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n112, err := m.ChecksumID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n112
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ChangeFrozen != nil {
		...
		n142, err := m.ChangeFrozen.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n142
	...
	if m.UpdateTxnRecord != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpdateTxnRecord.Size()))
		n146, err := m.UpdateTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n146
	}
	if m.ResolveWriteSlock != nil {
		dAtA[i] = 0x82
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ResolveWriteSlock.Size()))
		n147, err := m.ResolveWriteSlock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n147
	}
	if m.DyTsEndTransaction != nil {
		dAtA[i] = 0x8a
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DyTsEndTransaction.Size()))
		n148, err := m.DyTsEndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n148
	}
	if m.ValidateCommitAfter != nil {
		dAtA[i] = 0x92
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ValidateCommitAfter.Size()))
		n149, err := m.ValidateCommitAfter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n149
	}
	if m.ValidateCommitBefore != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ValidateCommitBefore.Size()))
		n150, err := m.ValidateCommitBefore.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n150
	}
	if m.GcWriteSoftLock != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GcWriteSoftLock.Size()))
		n151, err := m.GcWriteSoftLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n151
	}
	if m.GcReadSoftLock != nil {
		dAtA[i] = 0xaa
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GcReadSoftLock.Size()))
		n152, err := m.GcReadSoftLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n152
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ChangeFrozen != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ChangeFrozen.Size()))
		n179, err := m.ChangeFrozen.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n179
	...
	if m.UpdateTxnRecord != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpdateTxnRecord.Size()))
		n182, err := m.UpdateTxnRecord.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n182
	...
	if m.ResolveWriteSlock != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ResolveWriteSlock.Size()))
		n183, err := m.ResolveWriteSlock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n183
	...
	if m.DyTsEndTransaction != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DyTsEndTransaction.Size()))
		n184, err := m.DyTsEndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n184
	...
	if m.ValidateCommitAfter != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ValidateCommitAfter.Size()))
		n185, err := m.ValidateCommitAfter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n185
	...
	if m.ValidateCommitBefore != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ValidateCommitBefore.Size()))
		n186, err := m.ValidateCommitBefore.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n186
	...
	if m.GcWriteSoftLock != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GcWriteSoftLock.Size()))
		n187, err := m.GcWriteSoftLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n187
	...
	if m.GcReadSoftLock != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.GcReadSoftLock.Size()))
		n188, err := m.GcReadSoftLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n188
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TraceContext != nil {
		...
		n192, err := m.TraceContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n192
...
func (m *ReadSoftLock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadSoftLock) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.TransactionMeta.Size()))
	n194, err := m.TransactionMeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n194
...
func (m *WriteSoftLock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *WriteSoftLock) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.TransactionMeta.Size()))
	n195, err := m.TransactionMeta.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n195
	...
	n196, err := m.Request.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n196
...
func (m *UpdateTransactionRecordRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
	...
	n += 1 + l + sovApi(uint64(l))
	if len(m.CommitAfterThem) > 0 {
		for _, e := range m.CommitAfterThem {
			l = e.Size()
			n += 1 + l + sovApi(uint64(l))
		}
	}
	if len(m.CommitBeforeThem) > 0 {
		for _, e := range m.CommitBeforeThem {
			l = e.Size()
			n += 1 + l + sovApi(uint64(l))
		}
	}
...
func (m *UpdateTransactionRecordResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ResolveWriteSoftLocksRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ResolveWriteSoftLocksResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *GCWriteSoftockRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *GCWriteSoftockResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *GCReadSoftockRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *GCReadSoftockResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *DyTSEndTransactionRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
	...
	if len(m.ReverseReadSpans) > 0 {
		for _, e := range m.ReverseReadSpans {
			l = e.Size()
			n += 1 + l + sovApi(uint64(l))
		}
	}
...
func (m *DyTSEndTransactionResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ValidateCommitAfterRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ValidateCommitAfterResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ValidateCommitBeforeRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ValidateCommitBeforeResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *RequestUnion) Size() (n int) {
	...
	if m.ResolveWriteSlock != nil {
		l = m.ResolveWriteSlock.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	if m.DyTsEndTransaction != nil {
		l = m.DyTsEndTransaction.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	if m.ValidateCommitAfter != nil {
		l = m.ValidateCommitAfter.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	if m.ValidateCommitBefore != nil {
		l = m.ValidateCommitBefore.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	if m.GcWriteSoftLock != nil {
		l = m.GcWriteSoftLock.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	if m.GcReadSoftLock != nil {
		l = m.GcReadSoftLock.Size()
		n += 2 + l + sovApi(uint64(l))
	}
	return n
}
...
func (m *ReadSoftLock) Size() (n int) {
	var l int
	_ = l
	l = m.TransactionMeta.Size()
	n += 1 + l + sovApi(uint64(l))
	return n
}

func (m *WriteSoftLock) Size() (n int) {
	var l int
	_ = l
	l = m.TransactionMeta.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (this *RequestUnion) GetValue() interface{} {
	...
	if this.UpdateTxnRecord != nil {
		return this.UpdateTxnRecord
	}
	if this.ResolveWriteSlock != nil {
		return this.ResolveWriteSlock
	}
	if this.DyTsEndTransaction != nil {
		return this.DyTsEndTransaction
	}
	if this.ValidateCommitAfter != nil {
		return this.ValidateCommitAfter
	}
	if this.ValidateCommitBefore != nil {
		return this.ValidateCommitBefore
	}
	if this.GcWriteSoftLock != nil {
		return this.GcWriteSoftLock
	}
	if this.GcReadSoftLock != nil {
		return this.GcReadSoftLock
	}
	return nil
}
...
func (this *RequestUnion) SetValue(value interface{}) bool {
	...
	case *LeaseInfoRequest:
		this.LeaseInfo = vt
	case *UpdateTransactionRecordRequest:
		this.UpdateTxnRecord = vt
	case *ResolveWriteSoftLocksRequest:
		this.ResolveWriteSlock = vt
	case *DyTSEndTransactionRequest:
		this.DyTsEndTransaction = vt
	case *ValidateCommitAfterRequest:
		this.ValidateCommitAfter = vt
	case *ValidateCommitBeforeRequest:
		this.ValidateCommitBefore = vt
	case *GCWriteSoftockRequest:
		this.GcWriteSoftLock = vt
	case *GCReadSoftockRequest:
		this.GcReadSoftLock = vt
	default:
		return false
	}
	return true
...
func (this *ResponseUnion) SetValue(value interface{}) bool {
	...
	case *LeaseInfoResponse:
		this.LeaseInfo = vt
	case *UpdateTransactionRecordResponse:
		this.UpdateTxnRecord = vt
	case *ResolveWriteSoftLocksResponse:
		this.ResolveWriteSlock = vt
	case *DyTSEndTransactionResponse:
		this.DyTsEndTransaction = vt
	case *ValidateCommitAfterResponse:
		this.ValidateCommitAfter = vt
	case *ValidateCommitBeforeResponse:
		this.ValidateCommitBefore = vt
	case *GCWriteSoftockResponse:
		this.GcWriteSoftLock = vt
	case *GCReadSoftockResponse:
		this.GcReadSoftLock = vt
	default:
		return false
	}
...
func (m *UpdateTransactionRecordRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateTransactionRecordRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateTransactionRecordRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Tmeta", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Tmeta.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitAfterThem", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CommitAfterThem = append(m.CommitAfterThem, cockroach_storage_engine_enginepb.TxnMeta{})
			if err := m.CommitAfterThem[len(m.CommitAfterThem)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitBeforeThem", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CommitBeforeThem = append(m.CommitBeforeThem, cockroach_storage_engine_enginepb.TxnMeta{})
			if err := m.CommitBeforeThem[len(m.CommitBeforeThem)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *UpdateTransactionRecordResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateTransactionRecordResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateTransactionRecordResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResolveWriteSoftLocksRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResolveWriteSoftLocksRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResolveWriteSoftLocksRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResolveWriteSoftLocksResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResolveWriteSoftLocksResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResolveWriteSoftLocksResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GCWriteSoftockRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GCWriteSoftockRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GCWriteSoftockRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GCWriteSoftockResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GCWriteSoftockResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GCWriteSoftockResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GCReadSoftockRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GCReadSoftockRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GCReadSoftockRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GCReadSoftockResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GCReadSoftockResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GCReadSoftockResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DyTSEndTransactionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DyTSEndTransactionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DyTSEndTransactionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			...
			m.ReadSpans = append(m.ReadSpans, Span{})
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReverseReadSpans", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReverseReadSpans = append(m.ReverseReadSpans, Span{})
			if err := m.ReverseReadSpans[len(m.ReverseReadSpans)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
...
func (m *DyTSEndTransactionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DyTSEndTransactionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DyTSEndTransactionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ValidateCommitAfterRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidateCommitAfterRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidateCommitAfterRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			if m.LowerBound == nil {
				m.LowerBound = &cockroach_util_hlc.Timestamp{}
			}
			if err := m.LowerBound.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *ValidateCommitAfterResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidateCommitAfterResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidateCommitAfterResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ValidateCommitBeforeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidateCommitBeforeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidateCommitBeforeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			if m.UpperBound == nil {
				m.UpperBound = &cockroach_util_hlc.Timestamp{}
			}
			if err := m.UpperBound.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *ValidateCommitBeforeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidateCommitBeforeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidateCommitBeforeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			...
			if m.UpdateTxnRecord == nil {
				m.UpdateTxnRecord = &UpdateTransactionRecordRequest{}
			}
		...
		case 32:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResolveWriteSlock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ResolveWriteSlock == nil {
				m.ResolveWriteSlock = &ResolveWriteSoftLocksRequest{}
			}
			if err := m.ResolveWriteSlock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 33:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DyTsEndTransaction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DyTsEndTransaction == nil {
				m.DyTsEndTransaction = &DyTSEndTransactionRequest{}
			}
			if err := m.DyTsEndTransaction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateCommitAfter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ValidateCommitAfter == nil {
				m.ValidateCommitAfter = &ValidateCommitAfterRequest{}
			}
			if err := m.ValidateCommitAfter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateCommitBefore", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ValidateCommitBefore == nil {
				m.ValidateCommitBefore = &ValidateCommitBeforeRequest{}
			}
			if err := m.ValidateCommitBefore.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 36:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GcWriteSoftLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GcWriteSoftLock == nil {
				m.GcWriteSoftLock = &GCWriteSoftockRequest{}
			}
			if err := m.GcWriteSoftLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 37:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GcReadSoftLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GcReadSoftLock == nil {
				m.GcReadSoftLock = &GCReadSoftockRequest{}
			}
			if err := m.GcReadSoftLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			...
			if m.UpdateTxnRecord == nil {
				m.UpdateTxnRecord = &UpdateTransactionRecordResponse{}
			}
			if err := m.UpdateTxnRecord.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 32:
			...
			if m.ResolveWriteSlock == nil {
				m.ResolveWriteSlock = &ResolveWriteSoftLocksResponse{}
			}
			if err := m.ResolveWriteSlock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 33:
			...
			if m.DyTsEndTransaction == nil {
				m.DyTsEndTransaction = &DyTSEndTransactionResponse{}
			}
			if err := m.DyTsEndTransaction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 34:
			...
			if m.ValidateCommitAfter == nil {
				m.ValidateCommitAfter = &ValidateCommitAfterResponse{}
			}
			if err := m.ValidateCommitAfter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 35:
			...
			if m.ValidateCommitBefore == nil {
				m.ValidateCommitBefore = &ValidateCommitBeforeResponse{}
			}
			if err := m.ValidateCommitBefore.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 36:
			...
			if m.GcWriteSoftLock == nil {
				m.GcWriteSoftLock = &GCWriteSoftockResponse{}
			}
			if err := m.GcWriteSoftLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 37:
			...
			if m.GcReadSoftLock == nil {
				m.GcReadSoftLock = &GCReadSoftockResponse{}
			}
			if err := m.GcReadSoftLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *ReadSoftLock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadSoftLock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadSoftLock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransactionMeta", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TransactionMeta.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *WriteSoftLock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WriteSoftLock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WriteSoftLock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorApi = []byte{
	...
	,
}
