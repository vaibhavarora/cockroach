...
type Transaction struct {
	...
	// Tnxs before which the transaction has to commit
	CommitBeforeThem []cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,16,rep,name=commit_before_them,json=commitBeforeThem" json:"commit_before_them"`
	// Tnxs after which the transaction has to commit
	CommitAfterThem []cockroach_storage_engine_enginepb.TxnMeta `protobuf:"bytes,17,rep,name=commit_after_them,json=commitAfterThem" json:"commit_after_them"`
}
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	if r.Intn(10) != 0 {
		v11 := r.Intn(5)
		this.CommitBeforeThem = make([]cockroach_storage_engine_enginepb.TxnMeta, v11)
		for i := 0; i < v11; i++ {
			v12 := cockroach_storage_engine_enginepb.NewPopulatedTxnMeta(r, easy)
			this.CommitBeforeThem[i] = *v12
		}
	}
	if r.Intn(10) != 0 {
		v13 := r.Intn(5)
		this.CommitAfterThem = make([]cockroach_storage_engine_enginepb.TxnMeta, v13)
		for i := 0; i < v13; i++ {
			v14 := cockroach_storage_engine_enginepb.NewPopulatedTxnMeta(r, easy)
			this.CommitAfterThem[i] = *v14
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedLease(r randyData, easy bool) *Lease {
	...
	this.Expiration = *v16
	v17 := NewPopulatedReplicaDescriptor(r, easy)
	this.Replica = *v17
	v18 := cockroach_util_hlc.NewPopulatedTimestamp(r, easy)
	this.DeprecatedStartStasis = *v18
	if r.Intn(10) != 0 {
...
func NewPopulatedAbortCacheEntry(r randyData, easy bool) *AbortCacheEntry {
	...
	v21 := cockroach_util_hlc.NewPopulatedTimestamp(r, easy)
	this.Timestamp = *v21
...
var fileDescriptorData = []byte{
	...
	,
}
